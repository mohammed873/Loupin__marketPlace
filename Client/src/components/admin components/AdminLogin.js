    ...
    <div className="big_container">
        <div className="login">
          ...
          <div className="login-container">
            <p><input type="email" placeholder="Email" onChange={e=> setEmail(e.target.value)}  name="email" id="email" /></p>
            <p><input type="password" placeholder="Password" onChange={e=> setPassword(e.target.value)}  name="password" id="password" /></p>
            ...
            <p><input type="submit" value="Log in" onClick={onClick} /></p>
